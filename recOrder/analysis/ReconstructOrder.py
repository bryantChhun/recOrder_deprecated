...
class ReconOrder(AnalyzeBase):
    ...
    def __init__(self,
        ...
        # decorations
        # self.recon_from_monitor = \
        #     AnalyzeBase.bidirectional(emitter_channel=physical_emitter_channel,
        #                               receiver_channel=stokes_receiver_channel)(self.recon_from_monitor)
        # self.compute_stokes = \
    ...
    def recon_from_monitor(self, int_obj: IntensityData):
        ...
        if self.background:
            ...
            self.start_orientation(phys.retard, phys.azimuth)
            # self.compute_orientation(phys.retard, phys.azimuth)
            return phys
        else:
    ...
    def compute_physical(self, data: Union[StokesData, BackgroundData], flip_pol='rcp') -> PhysicalData:
        ...
        if isinstance(data, StokesData):
            print('computing physical with stokes data')
            """
        ...
        elif isinstance(data, BackgroundData):
...
# ===================================================================================================================
# ==================================== Two Implementations of Reconstruct Order =====================================
# one was copied and used here
# another is directly from Reconstruct Order (ImgReconstructor)
# in the past, we would use only ReconOrder2
# moving forward, we will use ImgReconstructor and simply wrap it as seen above.


class ReconOrder2(AnalyzeBase):
    """
